                ...
                {isCompanyInterview ? (
                    ...
                    <>
                        ...
                        <div className="w-full mb-8">
                            <div className="max-w-[1200px] mx-auto flex items-center gap-2 font-bold text-[12px] tracking-[0.05em] text-[#514441] uppercase">
                                <Link
                                    to="/scheduled-Interview"
                                    className="text-[#514441] hover:text-[#154212] transition-colors"
                                >
                                ...
                                <ChevronRight className="w-3.5 h-3.5 text-[#514441]" />         <ChevronRight className="w-3.5 h-3.5 text-[#514441]" />
                        ...
                        <div className="max-w-[1200px] mx-auto flex flex-col">
                            ...
                            <button
                                onClick={interview?.onStart}
                                className="w-full mt-6 bg-[#2d5a27] text-white py-4 rounded-lg text-[24px] font-semibold flex items-center justify-center gap-2"
                            >
                                START INTERVIEW
